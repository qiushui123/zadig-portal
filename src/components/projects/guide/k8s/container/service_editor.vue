...
export default {
  ...
  computed: {
    ...
    hideSave () {
      if (this.service.source === 'gitlab' || this.service.source === 'ilyshin' || this.service.source === 'github' || this.service.source === 'gerrit' || (this.service.visibility === 'public' && this.service.product_name !== this.projectName)) {
