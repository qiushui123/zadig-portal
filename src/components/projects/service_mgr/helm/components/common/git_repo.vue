  ...
  <div class="git-repo-container">
    ...
    <el-form v-if="gitName === 'private'" :model="source" :rules="sourceRules" ref="sourceForm" label-width="140px">
      ...
      <template>
        ...
        >
          <el-select v-model.trim="source.branchName" placeholder="请选择分支" style="width: 100%;" size="small" filterable allow-create remote :remote-method="(key)=> getBranchInfoById(source.codehostId,source.repoOwner,source.repoName, key)" clearable :disabled="isUpdate">
